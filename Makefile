...
pkgdatadir = $(datadir)/tsc
pkgincludedir = $(includedir)/tsc
pkglibdir = $(libdir)/tsc
pkglibexecdir = $(libexecdir)/tsc
...
ACLOCAL = ${SHELL} /data/yaoyf/tsc-pow-sha3/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /data/yaoyf/tsc-pow-sha3/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /data/yaoyf/tsc-pow-sha3/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /data/yaoyf/tsc-pow-sha3/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = tsc-cli
BITCOIN_DAEMON_NAME = tscd
BITCOIN_GUI_NAME = tsc-qt
BITCOIN_TX_NAME = tsc-tx
...
BOOST_LIBS = -L/usr/lib/x86_64-linux-gnu -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lboost_chrono -lboost_random
...
COPYRIGHT_HOLDERS_FINAL = The Tsc Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Tsc Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
CPPFILT = /usr/bin/c++filt
CPPFLAGS =  -DTSC_BUILD -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS
CRYPTOPP_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /data/yaoyf/tsc-pow-sha3/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = tsc
PACKAGE_BUGREPORT = https://github.com/tscproject/tsc/issues
PACKAGE_NAME = Tsc Core
PACKAGE_STRING = Tsc Core 0.15.2
PACKAGE_TARNAME = tsc
PACKAGE_URL = https://tsc.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /data/yaoyf/tsc-pow-sha3
abs_srcdir = /data/yaoyf/tsc-pow-sha3
abs_top_builddir = /data/yaoyf/tsc-pow-sha3
abs_top_srcdir = /data/yaoyf/tsc-pow-sha3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /data/yaoyf/tsc-pow-sha3/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/tsc-cli.bash-completion \
	       $(top_srcdir)/contrib/tsc-tx.bash-completion \
	       $(top_srcdir)/contrib/tscd.bash-completion \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Tsc-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Tsc-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Tsc-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Tsc-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
