...
public:
  ...
  //  std::vector<unsigned char> vchBlockSig;
    ...
    void SetNull()
    {
        ...
        nNonce         = 0;
		nNonce_ex      = 0;
        hashStateRoot  = uint256(); // tsc
        hashUTXORoot   = uint256(); // tsc
		//  [12/13/2018 taoist]
       // vchBlockSig.clear();
    ...
    CBlockIndex(const CBlockHeader& block)
    {
        ...
        nBits          = block.nBits;
        nNonce         = block.nNonce;
		nNonce_ex      = block.nNonce_ex;
        nMoneySupply   = 0;
        hashStateRoot  = block.hashStateRoot; // tsc
        hashUTXORoot   = block.hashUTXORoot; // tsc
		seed = block.seed;
        nStakeModifier = uint256();
        hashProof = uint256();
	    ...
	    sig5 = block.sig5;
		//  [12/13/2018 taoist]
        //prevoutStake   = block.prevoutStake; // tsc
       // vchBlockSig    = block.vchBlockSig; // tsc
    }
