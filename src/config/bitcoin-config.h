...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Tsc Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Tsc Core"
...
#define PACKAGE_BUGREPORT "https://github.com/tscproject/tsc/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Tsc Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Tsc Core 0.15.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tsc"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://tsc.org/"
