    ...
    platformStyle(_platformStyle)
{
    ...
    buyticketPage  = new BuyTicket(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    buyticketPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    buyticketPage->setModel(_walletModel);
...
void WalletView::gotoBuyTicketPage()
{
    setCurrentWidget(buyticketPage);
}
