...
////////////////////////////////////////////////////////////// tsc
        ...
        globalState = std::unique_ptr<TscState>(new TscState(dev::u256(0), TscState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::tscTestNetwork)));
