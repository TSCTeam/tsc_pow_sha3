...
public:
	...
	bool AcceptTicketTxToMemoryPool(const CAmount& nAbsurdFee, CValidationState& state);
	...
	{
		return tx->vout[0].scriptPubKey.HasOpSStx();
	}
...
public:
	...
	bool CreateTicketPurchaseTx(CWallet * const pwallet, CAmount ticketprice, CAmount minerFee, CWalletTx& wtxNew, const CCoinControl& coin_control, bool fHasbuyTicketAddress);
	bool CommitTicketTx(CWalletTx& wtxNew, CReserveKey& reservekey, CConnman* connman, CValidationState& state);
